...
- [x] **0.6** Set up project structure
...
- [x] **1.1** Implement tax calculation types
...
- [x] **1.4** Implement `recommendRegime()` and `runFullCalculation()`
...
- [x] **1.5** Run all tax calculator tests
...
- [x] **2.1** Run Prisma migration
  - `npx prisma migrate dev --name init`
  - Verify all tables created in Supabase

- [x] **2.2** Build Declaration API routes
...
- [x] **2.3** Build Property API routes
...
- [x] **2.4** Build PDF generation API
...
- [x] **3.2** Build regime comparison component
...
- [x] **3.3** Build pricing card component
...
- [x] **5.7** Add SEO meta tags to landing page
...
- [x] **8.1** Build formulaire 2044 PDF template
...
- [x] **8.2** Build step-by-step guide PDF
...
- [x] **8.3** Wire PDF generation to API
...
- [x] **9.1** Build Stripe checkout session API
...
- [x] **9.2** Build Stripe webhook handler
...
- [x] **11.1** Build blog index page
  - Route: `/blog`
  - List of articles with title, description, date
  - SEO meta tags

- [x] **11.2** Create 4 stub blog articles
...
- [x] **12.1** Add rate limiting to auth routes
  - Use middleware to limit to 10 req/min on `/api/auth`

- [x] **12.2** Add error boundaries
...
- [x] **12.4** Final typecheck + test run
